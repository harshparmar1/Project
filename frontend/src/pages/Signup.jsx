...
import { Calendar, User, Mail, Lock, Building2, Key, AlertCircle, CheckCircle, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <p className="text-sm text-slate-400">Join your department&apos;s scheduling portal</p>
        </div>
        ...
        {success && (
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="mb-6 p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 flex items-start gap-2.5 text-sm"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-900/50 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all placeholder:text-slate-500"
              />
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full bg-slate-900/50 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all appearance-none"
              >
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Code from your admin (e.g. DS2026)"
